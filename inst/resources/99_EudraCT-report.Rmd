...
EUdraCT_vocabulary = read_excel( CTutils::EUDRACT.FILE, sheet="EudraCT")
RMS_vocabulary = read_excel( CTutils::EUDRACT.FILE, sheet="RMS")
...
### Generating the SAE and AE XML uploads

```{r CTCAE1}

### Example shown below for NAXIVA trial
...
# eudract_upload_file <- sprintf( "%s/NAXIVA_safety_upload.xml", EUDRACT.XML.LOCATION )
# 
